...
import com.narmware.doormojo.adapter.BookingsAdapter;
...
import com.narmware.doormojo.pojo.MyBookingsResponse;
                        ...
                        try
                        {
                            ...
                            if(res==Constants.NEW_ENTRY) {
                                ...
                                for (MyBookings item : myBookings) {
                                    ...
                                    MyBookings booking=new MyBookings(item.getOrder_id(),item.getB_service_name(),item.getB_date(),item.getB_ratings(),item.getB_desc(),item.getB_price(),item.getB_service_img(),item.getB_status(),item.getB_no());
