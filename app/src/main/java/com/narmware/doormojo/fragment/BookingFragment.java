                        ...
                        try
                        {
                            ...
                            if(res==Constants.NEW_ENTRY) {
                                ...
                                for (MyBookings item : myBookings) {
                                    ...
                                    MyBookings booking=new MyBookings(item.getOrder_id(),item.getB_service_name(),item.getB_date(),"1",item.getB_desc(),item.getB_price(),item.getB_service_img(),item.getB_status(),item.getB_no());
