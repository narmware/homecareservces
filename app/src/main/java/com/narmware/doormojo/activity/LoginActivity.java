                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try
                        {
                            ...
                            if(res==Constants.NEW_ENTRY) {
                                ...
                                SharedPreferencesHelper.setBookName(loginResponse.getUser_name(),LoginActivity.this);
                                SharedPreferencesHelper.setBookMail(loginResponse.getUser_contact(),LoginActivity.this);
