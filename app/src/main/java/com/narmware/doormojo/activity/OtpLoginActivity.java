...
import com.narmware.doormojo.MainActivity;
            ...
            public void onClick(View v) {
                ...
                if(otp.equals(""))
                {
                    ...
                    if(otp.equals(server_otp))
                    {
                        ...
                        SharedPreferencesHelper.setBookName(name,OtpLoginActivity.this);
                        SharedPreferencesHelper.setBookMobile(mobile,OtpLoginActivity.this);
                        SharedPreferencesHelper.setBookMail(email,OtpLoginActivity.this);
                        ...
                        Intent intent=new Intent(OtpLoginActivity.this,BottomNavigationActivity.class);
