...
public class AddressFragment extends Fragment {
    ...
    @BindView(R.id.txt_dt_title) TextView mTxtTitle;
    ...
    private void init(View view) {
        ...
        if(isEdit==true)
        {
            ...
            mTxtTitle.setText("Complete your profile");
        }
    ...
    public void HomeEnabled()
    {
        ...
        mBtnHome.setTextColor(getContext().getResources().getColor(R.color.colorAccent));
    ...
    public void HomeDisable()
    {
        ...
        mBtnOffice.setTextColor(getContext().getResources().getColor(R.color.colorAccent));
