...
import com.narmware.homecare.activity.BookAppointmentActivity;
...
public class SubServicesAdapter extends RecyclerView.Adapter<SubServicesAdapter.MyViewHolder> {
    ...
    public SubServicesAdapter(Context context, List<SubServices> services, FragmentManager fragmentManager) {
