package com.narmware.homecare.adapter;
...
public class ServiceMainAdapter extends RecyclerView.Adapter<ServiceMainAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
           ...
           /* adapter = new SubServicesAdapter(mContext, subServices, fragmentManager);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try
                        {
                            ...
                            SubServicesAdapter adapter = new SubServicesAdapter(mContext, subServices, fragmentManager);
        ...
        protected void onPostExecute(String s) {
            ...
            try{
                ...
                if(subServiceResponse.getResponse().equals("100")) {
                    ...
                    mHolder.adapter = new SubServicesAdapter(mContext, mHolder.subServices, fragmentManager);
